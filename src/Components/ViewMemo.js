  ...
  // import { MEMO_SERVICE_VIEW, MEMO_SERVICE_DELETE, MEMO_SERVICE_VIEW_PAGINATE } from "../config/ConfigUrl";
  ...
  //       const response = await axios.get(`${MEMO_SERVICE_VIEW}?${urlParams}`, { headers });
...
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faEdit, faTrash } from "@fortawesome/free-solid-svg-icons";
import { MEMO_SERVICE_DELETE, MEMO_SERVICE_VIEW_PAGINATE } from "../config/ConfigUrl";
...
const ViewMemo = () => {
  ...
  //       console.log("Set URL Params", urlParams);
  //     } else {
  //       urlParams = `size=${pageSize}&page=${currentPage}&sort=id,desc`;
  //       console.log("Set URL Params", urlParams);
  //     }

  //     const response = await axios.get(`${MEMO_SERVICE_VIEW_PAGINATE}?${urlParams}`, { headers });
  //     setData(response.data.internalMemo); // Update here
  //     setTotalItem(response.data.totalItems);
  //     console.log(response.data);
  //   } catch (error) {
  //     console.error("Error fetching data: ", error);
